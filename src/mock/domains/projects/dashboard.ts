...
const SPECS: Spec[] = [
  ...
  // ── Closed / shipped (15) ────────────────────────────────────────────────
  {
    ...
    phase: 'learn', currentStage: null, owner: OWNERS.admin, collaborators: [OWNERS.mira, OWNERS.leon],
  ...
  },
  {
    ...
    phase: 'learn', currentStage: null, owner: OWNERS.leon, collaborators: [OWNERS.devon],
  ...
  },
  {
    ...
    phase: 'learn', currentStage: null, owner: OWNERS.aisha, updatedDays: 19, latestArtifact: { kind: 'plan', version: 1 }, repoCount: 4,
  },
  {
    name: 'Audit-log redaction', summary: 'Redact secrets and PII from the audit trail before it leaves the boundary.',
    phase: 'learn', currentStage: null, owner: OWNERS.devon, updatedDays: 26, latestArtifact: { kind: 'plan', version: 1 }, repoCount: 2,
  },
  {
    name: 'Realtime collaboration cursors', summary: 'Live presence and shared cursors in the editor, with conflict-free merges.',
    phase: 'learn', currentStage: null, owner: OWNERS.mira, collaborators: [OWNERS.devon, OWNERS.aisha],
  ...
  },
  {
    ...
    phase: 'learn', currentStage: null, owner: OWNERS.mira, updatedDays: 41, latestArtifact: { kind: 'plan', version: 1 }, repoCount: 1,
  },
  {
    name: 'Billing usage metering', summary: 'Meter token + compute usage per team and roll it up for invoicing.',
    phase: 'learn', currentStage: null, owner: OWNERS.admin, collaborators: [OWNERS.leon],
  ...
  },
  {
    ...
    phase: 'learn', currentStage: null, owner: OWNERS.devon, updatedDays: 63, latestArtifact: { kind: 'plan', version: 1 }, repoCount: 2, visibility: 'public',
  },
  {
    name: 'Search relevance v2', summary: 'Hybrid lexical + semantic ranking with a feedback-driven tuning loop.',
    phase: 'learn', currentStage: null, owner: OWNERS.aisha, collaborators: [OWNERS.admin],
  ...
  },
  {
    ...
    phase: 'learn', currentStage: null, owner: OWNERS.leon, updatedDays: 90, latestArtifact: { kind: 'plan', version: 1 }, repoCount: 2,
  },
  {
    name: 'Rate limiter v2', summary: 'Token-bucket rate limiting with per-tenant quotas and burst credits.',
    phase: 'learn', currentStage: null, owner: OWNERS.devon, collaborators: [OWNERS.mira],
  ...
  },
  {
    ...
    phase: 'learn', currentStage: null, owner: OWNERS.admin, updatedDays: 130, latestArtifact: { kind: 'plan', version: 2 }, repoCount: 3, visibility: 'public',
  },
  {
    name: 'Feature flags service', summary: 'Targeted rollouts with audiences, kill switches, and an audit trail.',
    phase: 'learn', currentStage: null, owner: OWNERS.mira, collaborators: [OWNERS.aisha],
  ...
  },
  {
    ...
    phase: 'learn', currentStage: null, owner: OWNERS.aisha, updatedDays: 188, latestArtifact: { kind: 'plan', version: 1 }, repoCount: 1,
  },
  {
...
const PROJECTS: DashboardProject[] = SPECS.map((s, i) => {
  ...
  return {
    ...
    isMember: true,
    stages: buildStages(s.currentStage, s.phase === 'learn'),
